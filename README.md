...
|---|---|---:|---:|---:|---:|
| Read p99 | < 500 ms | 470 ms | 180 ms | 65 ms | 55 ms |
| Read max RPS | ≥ 100 | 180 | 540 | 980 | 1450 |
| Write p99 | < 1000 ms | 720 ms | 380 ms | 360 ms | 340 ms |
| Write max RPS | ≥ 30 | 45 | 110 | 120 | 145 |
| Error rate | < 1% | 0.4% | 0.2% | 0.1% | 0.1% |
| Bottleneck | — | pgxpool + Seq Scan | HDD WAL fsync на write | Go GC + nginx upstream | Postgres CPU 88% |
